...
| 睡莲                               | 一种不知名花                       |
| ---------------------------------- | ---------------------------------- |
| ![alt text](./images/image-29.png) | ![alt text](./images/image-28.png) |
| 基础环面                           | 曼陀罗花和睡莲的结合体             |
| ![alt text](./images/image-30.png) | ![alt text](./images/image-31.png) |
| 11瓣的水莲花                       | 八角正方形的star                   |
| ![alt text](./images/image-32.png) | ![alt text](./images/image-33.png) |
| 公园里的荷花形状                   | 椭圆弧的花                         |
...
1. 下载并安装Python
   - 下载Python,打开官网 https://www.python.org/ 如下图，点击Downloads![alt text](./images/image.png)
   点击按钮下载当前最新版：
