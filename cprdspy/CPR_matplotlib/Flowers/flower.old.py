...
# def oval_petal(a,b,d,rotation=0,color='#0f0',alpha=1,center=(0,0),points=1000):
...
#     oval_arc(a,b,beta_b1,beta_e1,angle=rotation,color=color,alpha=alpha,center=center1_rot,points=points)
#     oval_arc(a,b,beta_b2,beta_e2,angle=rotation,color=color,alpha=alpha,center=center2_rot,points=points)
...
def oval_petal_flower(
    a, b, d, n=12, rotation=0, color="#0f0", alpha=1, center=(0, 0), points=1000
):
    for i in range(n):
        oval_petal(
            a,
